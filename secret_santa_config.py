...
personal_info_dict = {"Anna": ("anna@gmail.com", "1 Central Park Ave, Penthouse Suite 1"), "Beth": ("beth@gmail.com", "2 Central Park Ave, Penthouse Suite 1"), "Charlie": ("charlie@gmail.com", "3 Central Park Ave, Penthouse Suite 1"), "Daphne": ("daphne@gmail.com", "4 Central Park Ave, Penthouse Suite 4"), "Evan": ("evan@gmail.com", "5 Central Park Ave, Penthouse Suite 5"), "Frank": ("frank@gmail.com", "6 Central Park Ave, Penthouse Suite 6"), "George": ("george@gmail.com", "7 Central Park Ave, Penthouse Suite 1")} # Enter the info of all the paricipants here as a dict with names as keys and a tuple containing an email address and physical address as the value i.e. {"Anna":(anna@email.com, "111 Main st") "Beth":(beth@email.com, "222 Main st") "Charlie":(charlie@email.com, "333 Main st")}
